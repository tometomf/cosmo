		...
		<div class="main">
			...
			<div class="content_Form1" style="margin-top: 25px;">
				...
				<div class="form_Text1" id="form_Text2">
					...
					<div class="form_Normal" style="color: red;">2013/01/04</div>
				</div>
				<div class="form_Text1" id="form_Text2">
			...
			<div style="display: flex; gap: 15px; margin-top: 20px;">
				<!-- 첫 번째 박스 -->
				<div class="content_Form2" style="flex: 1;">
					<div style="font-size: 13px;">
						<div class="form_Text1" id="form_Text2">
							<div class="form_Column">付随者欄</div>
							<div class="form_Normal">
				...
				<div class="content_Form2" style="flex: 1;">
					<div style="font-size: 13px;">
						...
						<div class="form_Text1" id="form_Text2">
							...
							<div class="form_Normal" style="color: red;">品川 300 い 1111</div>
						</div>
						<div class="form_Text1" id="form_Text2">
							<div class="form_Column">排気量</div>
							<div class="form_Normal" style="color: red;">3000CC</div>
						</div>
						<div class="form_Text1" id="form_Text2">
				...
				<div class="content_Form2" style="flex: 1;">
					<div style="font-size: 13px;">
						...
						<div class="form_Text1" id="form_Text2">
							<div class="form_Column">人身傷害</div>
							<div class="form_Normal">無制限万円</div>
						</div>
						<div class="form_Text1" id="form_Text2">
							<div class="form_Column">搭乗者傷害</div>
							<div class="form_Normal">無制限万円</div>
						</div>
						<div class="form_Text1" id="form_Text2">
							<div class="form_Column">等級</div>
							<div class="form_Normal">36S等級</div>
						</div>
					</div>
				</div>
			</div>
